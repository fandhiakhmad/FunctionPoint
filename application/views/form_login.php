...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Halaman Login Aplikasi Function Point</title>
    ...
    <div class="row">
        <div class="well col-md-5 center login-box">
            <div class="alert alert-info">
             ...
             <form class="form-horizontal" action="<?php echo site_url()?>login/auth" method="post">
                <fieldset>
