...
<div class="row">
	...
	foreach($isi->result() as $row){
		/*
	jika sudah tidak ada dokumen yang dicetak lgi, maka print kosong
	...
	*/
	...
	<td>
	<?php if($role <=2){?>
	<a href="<?php echo base_url() ?>estimasi/lihat_tim/<?php echo $row->ID_APLIKASI; ?>"><?php echo $row->NAMA_TIM;?> </a>
