...
function makeAjaxCall(){
	...
	$.ajax({
		type: "post",
		url: "<?php echo base_url(); ?>estimasi/add_tcf",
		cache: false,				
		data: $('#tcf').serialize(),
		...
		while(index<=obj['size']){
			...
			alert( obj['STATUS']);
			window.location.href = "<?php echo base_url();?>estimasi/form_tcf";	
      ...
      <div class="box-content">
		...
		<tr>
				...
				<label class="radio-inline">
					...
					<input type="hidden" name="idtcf<?php echo $n;?>" id="inlineRadio2" value="<?php echo $row->ID_P_TCF; ?>">
				...
				<td>
				<label class="radio-inline">
                    <input type="radio" name="surveytcf<?php echo $n;?>" id="inlineRadio2" value="0"> 0
                </label>
				<label class="radio-inline">
				
				
                    <input type="radio" name="surveytcf<?php echo $n;?>" id="inlineRadio2" value="1">1
					<input type="hidden" name="idtcf<?php echo $n;?>" id="inlineRadio2" value="<?php echo $row->ID_P_TCF; ?>">
					<input type="hidden" name="bobot<?php echo $n;?>" id="inlineRadio2" value="<?php echo $row->BOBOT; ?>">
				</label>
				...
				<label class="radio-inline">
                    <input type="radio" name="surveytcf<?php echo $n;?>" id="inlineRadio2" value="2"> 2
                </label>
				
				<label class="radio-inline">
                    <input type="radio" name="surveytcf<?php echo $n;?>" id="inlineRadio2" value="3"> 3
                </label>
				<label class="radio-inline">
                    <input type="radio" name="surveytcf<?php echo $n;?>" id="inlineRadio2" value="4"> 4
                </label>
				
				<label class="radio-inline">
                    <input type="radio" name="surveytcf<?php echo $n;?>" id="inlineRadio2" value="5"> 5
                </label>
				<p ><font id="errkategori<?php echo $n;?>" color="red"></font></p>
				</td>
				</tr>
		...
		<?php if($step<=5 && isset($nilai_tcf)){?>					
				<a class="btn btn-primary"     id="next" onclick="return confirm('Anda Yakin?. Pastikan semua Indikator diisi')"  style="float: right;"  href="<?php echo base_url(); ?>estimasi/form_ecf"> 
...
<?php }?>
			...
			<div class="form-inline " >
                       <b> <label for="exampleInputEmail1">Nilai TCF: </label>
                        <label id="hasil">&nbsp;&nbsp;<?php if(isset($nilai_tcf)){ echo $nilai_tcf;} else{  echo 0;}?></label> </b> 
