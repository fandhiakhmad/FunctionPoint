                  ...
                  <table width="400" height="287" border="0">
                    <tr>
                      <th width="227" scope="col">
                        <div align="left">Nilai UUCW <br> (<i>Unajusted Use Case Weight</i>)</div>
                      </th>
                    ...
                    <tr>
                      <th scope="row">
                        <div align="left"> Nilai UAW <br> (<i>Unajusted Actor Weight</i>) </div>
                      </th>
                      <td><strong> :</strong></td>
                      <td><?php echo $uaw; ?></td>
                    </tr>
                    <tr>
                      <th scope="row">
                        <div align="left">Nilai ECF <br> (<i>Enviromental Complexity Factor </i>)</div>
                      </th>
                      <td><strong>:</strong></td>
                      <td><?php echo $ecf; ?></td>
                    </tr>
                    <tr>
                      <th scope="row">
                        <div align="left">Nilai TCF<br>(<i>Tecnical Complexity Factor </i>)</div>
                      </th>
                      <td><strong>:</strong></td>
                      <td><?php echo $tcf; ?></td>
                    </tr>
                    <tr>
                      <th scope="row">
                        <div align="left">Nilai UCP  <br><i>( (UUCW+UAW)* TCF * ECF) </i></div>
                      </th>
                      <td><strong>:</strong></td>
                  ...
                  <table width="461" height="55" border="0">
                    <tr>
                      <th width="274" height="24" scope="row">
                        <div align="left">Nilai ER <br> (<i>Effort Rate</i>)  </div>
                      </th>
