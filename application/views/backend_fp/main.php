...
<?php echo $content; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a href="<?php echo base_url(); ?>#" class="btn btn-default" data-dismiss="modal">Close</a>
                    <a href="<?php echo base_url(); ?>#" class="btn btn-primary" data-dismiss="modal">Save changes</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="<?php echo base_url(); ?>http://usman.it" target="_blank">Function Point Application</a> 2018 - 2019</p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Developed by: <a
                href="<?php echo base_url(); ?>http://usman.it/free-responsive-admin-template">Fandhi Akhmad</a></p>
    </footer>
