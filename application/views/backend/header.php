...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Aplikasi Estimasi Harga Perangkat Lunak</title>
...
<body>
    ...
    <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-inner">
			...
			<center>
            <a class="navbar-brand" href="<?php echo base_url(); ?>homepage"> <img alt="Charisma Logo" src="<?php echo base_url(); ?>images/favicon.ico" class="hidden-xs"/>
                <span>Aplikasi Estimasi Harga Perangkat Lunak</span></a>
</center>
            ...
            <div class="btn-group pull-right">
                ...
                <li><a href="<?php echo base_url(); ?>user/edit/<?php echo $id_user;?>">Edit Profil</a></li>
