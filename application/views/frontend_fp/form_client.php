    ...
    <div class="box-inner">
      ...
      <div class="box-content">
        <ul class="nav nav-tabs" >
          ...
          <?php if($step >=1) {?> 
          <li class="active" ><a href="<?php echo base_url(); ?>estimasi_fp/form_edit_client/<?php echo $this->session->userdata('id_aplikasi')?>">Informasi Client <?php if(isset($edit)){ echo'<span class="label label-info">Edit</span>';} ?></a></li>
          <?php } else {  ?> 
          <li  class="active" ><a href="#info">Informasi Client</a></li>
          <?php } ?>
         ...
         <?php if($step >=2){?> 
          ...
          <?php }
		     ...
		     <li  ><a href="<?php echo base_url(); ?>estimasi_fp/form_aplikasi/<?php echo $this->session->userdata('id_aplikasi')?>">Deskripsi Aplikasi </a></li>
		     <?php }
		     else { ?>
...
-->
	   ...
	   <div id="myTabContent" class="tab-content">
          ...
          <?php if($step>=1)
          { 
            echo '<form  role="form" method="post" id="calucw"  action="'.base_url().'estimasi_fp/update_client" >';
          } else {
            echo '<form  role="form" method="post" id="calucw"  action="'.base_url().'estimasi_fp/add_client" >';
          }?>
          ...
          <div class="tab-pane active" id="info">
            ...
            <div class="row">
              <div class="col-md-4">
				...
				<p class="help-block">Contoh: Bapak Fandhi</p>
				</div>
          ...
          <p class="help-block">Contoh: Mulyosari Utara 7 No 29</p>
				 </div>
        </div>
				...
				<p class="help-block">Contoh: 01-07-2018 </p>
				</div>
