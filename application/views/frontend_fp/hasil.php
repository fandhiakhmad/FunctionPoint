...
<script>
  ...
  document.getElementById('loader').style.visibility='visible';
   var url_pas="<?php echo base_url();?>estimasi_fp/submit";
    	...
    	var obj = jQuery.parseJSON(json);
  	   ...
  	   document.getElementById('loader').style.visibility='hidden';
	   	window.location.href = "<?php echo base_url();?>log_estimasi";	
  ...
  function kirimNilai(){
  url_pas="<?php echo base_url();?>estimasi_fp/tambah_op";
	    ...
	    if(obj['errdeskripsi'] =="" && obj['errnilai'] ==""){
				window.location.href = "<?php echo base_url();?>estimasi_fp/result";	
			}
  ...
  var string="<?php echo base_url();?>estimasi_fp/update_bop/".concat(index);
          ...
          <?php } ?>
				...
				<?php if($step >=2){?> 
				 ...
				 <?php } ?> -->
					...
					<?php if($step >=7){?> 
					 <li class="active" ><a href="<?php echo base_url(); ?>estimasi_fp/result"  >Result</a></li>
					<?php } else {  ?> 
              ...
              <div class="row">
                <div class="col-md-6">
                  <label class="control-label" for="selectError">
                    <h3>Hasil Akhir Perhitungan Nilai FP</h3>
                  </label>
                  <table width="400" height="287" border="0">
                    <tr>
                      <th width="227" scope="col">
                        <div align="left">Nilai CFP <br> (<i>Crude Function Point</i>)</div>
                      </th>
                      <th width="10" scope="col">
                        <div align="left">:</div>
                      </th>
                      <td width="68" scope="col">
                        <div align="left"><?php echo $cfp; ?></div>
                      </td>
                    </tr>
                    
                    <tr>
                      <th scope="row">
                        <div align="left"> Nilai RCAF <br> (<i>Relative Complexity Adjustment Factor</i>) </div>
                      </th>
                      <td><strong> :</strong></td>
                      <td><?php echo $rcaf; ?></td>
                    </tr>
                    ...
                    <tr>
                      <th scope="row">
                        <div align="left">Nilai FP  <br><i>CFP * (0.65 + 0.01 * RCAF) </i></div>
                      </th>
                      <td><strong>:</strong></td>
                      <td><b><?php echo $nilai_fp;?></b></td>
                      <td>&nbsp;</td>
                    </tr>
                  </table>
                </div>
                  ...
                  <table width="461" height="55" border="0">
                    <tr>
                      <th width="274" height="24" scope="row">
                        <div align="left">Nilai Effort Rate <br> (<i>Konstanta</i>)  </div>
                      </th>
                    ...
                    <tr>
                      <th height="25" scope="row">
                        <div align="left">Nilai Total Usaha <br> (<i>Hour of Effort</i>) </div>
                      </th>
                      <td><strong>:</strong></td>
                      <td colspan="3"><?php echo $effort_estimate; ?></td>
                    </tr>
                  </table>
                </div>
              </div>
            ...
            <label class="control-label" for="selectError">
              <h3>Rekap Biaya Tiap Aktivitas  <?php if(isset($edit)){?> <span class="label label-info">Edited</span> <?php }?></h3>
            </label>
            <div class="row">
              <div class="col-md-7">
                ...
                <form  method="post" action="<?php echo base_url(); ?>estimasi_fp/update_biaya" >
				 <?php if(isset($edit)){?>
                  <table width="600" border="1"  class="table-bordered" >
                    ...
                    <tr>
                      <th  scope="row">TOTAL BIAYA POKOK PERANGKAT LUNAK </th>
				...
				<?php }?>
				    <!-- jika ada pengubahan biaya, maka pakai format tabel seperti pada bagian berikut -->
				  <br>
                ...
                <table  border="1"  class="table-bordered" >
                  ...
                  <form method="post" id="update_bop" action="" >
                    ...
                    <tr >
                      ...
                      <td class="center">
                        ...
                        <a class="btn btn-default btn-sm" style="display:none;" id="cancle<?php echo $index;?>"  href="<?php echo base_url(); ?>estimasi_fp/result">
                        <i class="glyphicon glyphicon-edit icon-white"></i>
                        Cancel
                        </a>
                        <a class="btn btn-danger btn-sm"  id="hapus<?php echo $index;?>" onclick="return confirm('Anda Yakin untuk menghapus?')"   href="<?php echo base_url(); ?>estimasi_fp/delete_bop/<?php echo $row->ID_OP; ?>" > 
                  ...
                  <tr id="TampilkanForm" style="display:none;" >
                    ...
                    <td>
                      ...
                      <a class="btn btn-default "  href="<?php echo base_url(); ?>estimasi_fp/result">
                      <i class="glyphicon glyphicon-edit icon-white"></i>
                      Cancel
                      </a>
                    </td>
                ...
                <table>
                  <tr>
                    ...
                    <form method="post"  id="kirim" action="" >
                      <div class="form-group">
                        <input type="hidden"  name="biaya_estimasi"  class="form-control" value="<?php echo $total_biaya+$total; ?>"id="total" style="width:400px">
                        <input type="hidden"  name="effort_estimate"  class="form-control" value="<?php echo $effort_estimate ?>"id="total_estimate" style="width:400px">
                      </div>
                    </form>
					<?php if($status==0){?>
					...
					<div style="visibility:hidden" id="loader">
                      <img    src="<?php echo base_url()?>images/ajax-loaders/ajax-loader-1.gif" title="images/ajax-loaders/ajax-loader-1.gif">
                    </div>
                    <?php 	} ?>
					  <a class="btn btn-primary"   href="<?php echo base_url(); ?>log_estimasi"> 
               <i class="glyphicon glyphicon-chevron-left glyphicon-white"></i> Kembali ke Daftar Estimasi
