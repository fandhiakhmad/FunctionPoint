    ...
    <div class="box-inner">
      ...
      <div class="box-content">
        ...
        <ul class="nav nav-tabs" >
          ...
          <?php } else {  ?> 
          <li class="active" ><a href="#">CFP</a></li>
          <?php } ?>
          
          <?php if($step >=4){?> 
          <li ><a href="<?php echo base_url(); ?>estimasi_fp/form_rcaf"  >RCAF</a></li>
          <?php } else {  ?> 
                  ...
                  <table width="400" height="287" border="0">
                    <tr>
                      <th width="227" scope="col">
                        <div align="left">Crude Function Point</div>
                      </th>
                    ...
                    <tr>
                      <th scope="row">
                        <div align="left">Relative Complexity Adjustment Factor</div>
                      </th>
                      <td><strong> :</strong></td>
                      <td><?php echo $rcaf; ?></td>
                    </tr>
                    ...
                    <tr>
                      <th scope="row">
                        <div align="left">Function Point </div>
                      </th>
                      <td><strong>:</strong></td>
