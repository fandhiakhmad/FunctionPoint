...
<div class="row">
  <div class="box col-md-12">
    <div class="box-inner">
      ...
      <div class="box-content">
        ...
        <?php if($step >=1){?> 
          ...
          <?php if($step >=2){?> 
          <li class="active" ><a href="<?php echo base_url(); ?>estimasi_fp/form_edit_aplikasi/<?php echo $this->session->userdata('id_aplikasi')?>">Deskripsi Aplikasi <?php if(isset($edit)){ echo'<span class="label label-info">Edit</span>';} ?></a></li>
         <?php }
		     else if ($step ==1){ ?>
			   <li class="active" ><a href="<?php echo base_url(); ?>estimasi_fp/form_aplikasi/<?php echo $this->session->userdata('id_aplikasi')?>">Deskripsi Aplikasi </a></li>
		     <?php }
		     else {  ?> 
          ...
          <?php } else {  ?> 
          <li class="disabled" ><a href="#info">CFP</a></li>
          <?php } ?>
		...
		<div id="myTabContent" class="tab-content">
          ...
          <?php if($step>=2)
          { 
            echo '<form  role="form" method="post" id="calucw"  action="'.base_url().'estimasi_fp/update_aplikasi/" >';
          } else {
            echo '<form  role="form" method="post" id="calucw"  action="'.base_url().'estimasi_fp/add_aplikasi" >';
          }?>
               ...
               <p class="help-block">Contoh: Aplikasi FP</p>
			   </div>
                
              <div class="form-group">
                  <label class="control-label" for="inputSuccess1">Penggunaan Metode<font color="red">*</font></label></p>
                  <div class="radio"    >
                    <label>
                    ...
                    Function Point Modified
                    </label>
                  <p class="help-block">Adanya penambahan karakteristik software berupa kompleksitas proses bisnis</p>
				</div>
             
                  <?php if(isset($errtemplete)){ echo '<p><font color="red">Penggunaan metode  belum diisi</font></p>'; }?>
                </div>
                <div class="form-group">
              ...
              <div class="col-md-7">
                <h3>Fitur Aplikasi</h3>
				 ...
				 <form class="form-inline" role="form" method="post" id="fitur"  action="<?php echo base_url();?>estimasi_fp/add_fitur"  >
	...
	<td>  
			...
			<a class="btn btn-danger btn-sm"  onclick="return confirm('Anda Yakin untuk menghapus fitur <?php echo $row->NAMA_FITUR; ?>?')"   href="<?php echo base_url(); ?>estimasi_fp/delete_fitur/<?php echo $row->ID_FITUR; ?>" > 
 ...
 <!-- <?php if($step <=2 && $fitur->num_rows!=0) {?> -->
				<!-- <?php } ?>  -->
        <a class="btn btn-primary"   onclick="return confirm('Anda Yakin?')"  style="float: right;"  href="<?php echo base_url(); ?>estimasi_fp/form_cfp"> 
              Berikutnya
