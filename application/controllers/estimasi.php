...
class Estimasi extends CI_Controller
{
    ...
    public function form_client()
    {
        ...
        $data['header']    = $this->load->view('backend/header', $user, true);
        $user['nama']      = $this->session->userdata('nama');
		$user['id_user']      = $this->session->userdata('id_user');
		$role['role']      = $this->session->userdata('role');
		
		$data['menu_kiri'] = $this->load->view('backend/menu_kiri',$role, true);
		
        $data['content']   = $this->load->view('frontend/form_client', $isi, true);
    ...
    public function form_aplikasi($id_aplikasi)
    {
		...
		$data['menu_kiri'] = $this->load->view('backend/menu_kiri',$role, true);
        $data['content']   = $this->load->view('frontend/form_aplikasi', $isi, true);
    ...
    public function form_uucw()
    {
		...
		$data['menu_kiri'] = $this->load->view('backend/menu_kiri',$role, true);
        $data['content']   = $this->load->view('frontend/form_uucw', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function form_uaw()
    {
		...
		$data['menu_kiri'] = $this->load->view('backend/menu_kiri',$role, true);
        $data['content']    = $this->load->view('frontend/form_uaw', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function form_tcf()
    {
		...
		$data['menu_kiri'] = $this->load->view('backend/menu_kiri',$role, true);
        $data['content']   = $this->load->view('frontend/form_tcf', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function form_ecf()
    {
		...
		$data['menu_kiri'] = $this->load->view('backend/menu_kiri',$role, true);
        $data['content']   = $this->load->view('frontend/form_ecf', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function result()
    {
       ...
       // $distribusi_usaha        = $this->aktivitas_model->get_data_aktivitas();
		...
		$data['menu_kiri'] = $this->load->view('backend/menu_kiri',$role, true);
        $data['content']   = $this->load->view('frontend/hasil', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function popUCW()
    {
        ...
        $isi['isi']        = $this->uc_model->get_data_uc();
        $data['content']   = $this->load->view('frontend/popup/daftar_ucw', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function popAW()
    {
        ...
        $isi['pesan']      = $this->session->flashdata('pesan');
        $isi['isi']        = $this->aw_model->get_data_aw();
        $data['content']   = $this->load->view('frontend/popup/daftar_aw', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function popTCF()
    {
        ...
        $isi['pesan']      = $this->session->flashdata('pesan');
        $isi['isi']        = $this->tcf_model->get_data_tcf();
        $data['content']   = $this->load->view('frontend/popup/daftar_tcf', $isi, true);
        $this->load->view('/backend/main', $data);
    }
    ...
    public function popECF()
    {
        ...
        $isi['pesan']      = $this->session->flashdata('pesan');
        $isi['isi']        = $this->ecf_model->get_data_tcf();
        $data['content']   = $this->load->view('frontend/popup/daftar_ecf', $isi, true);
        $this->load->view('/backend/main', $data);
    }
