...
class Tim extends CI_Controller
	...
	public function daftar_tim()
		{
		$data['header'] = $this->load->view('backend_fp/header', true);
		$data['menu_kiri'] = $this->load->view('backend_fp/menu_kiri', true);
		$isi['pesan']=$this->session->flashdata('pesan');
		$isi['isi'] = $this->tim_model->get_data_tim();
		$data['content'] = $this->load->view('backend_fp/daftar_tim', $isi, true);
	...
	public function form_tim()
		...
		$data['header'] = $this->load->view('backend_fp/header', true);
		$data['menu_kiri'] = $this->load->view('backend_fp/menu_kiri', true);
		$data['content'] = $this->load->view('backend_fp/form_tim', $isi, true);
		$this->load->view('/backend_fp/main', $data);
		}
