...
echo "</table>";
		...
		echo "Nilai Rata-Rata ER dengan Function Point : ".round($rata_rata_template,2);
		echo "<br>";
		echo "Nilai Rata-Rata ER dengan Function Point Modified: ".round($rata_rata_framework,2);
		}
	}
